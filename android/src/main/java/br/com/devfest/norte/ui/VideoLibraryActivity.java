...
public class VideoLibraryActivity extends BaseActivity implements VideoLibraryFragment.Callbacks {
    ...
    private static final String STATE_KEY_YEAR = "br.com.devfest.norte.STATE_KEY_YEAR";
    private static final String STATE_KEY_TOPIC = "br.com.devfest.norte.STATE_KEY_TOPIC";
