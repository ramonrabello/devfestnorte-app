...
import br.com.devfest.norte.ui.widget.CollectionView;
import br.com.devfest.norte.ui.widget.CollectionViewCallbacks;
import br.com.devfest.norte.ui.widget.MessageCardView;
import br.com.devfest.norte.util.ImageLoader;
import br.com.devfest.norte.util.UIUtils;
...
public class ExpertsDirectoryFragment extends Fragment implements
    ...
    /**
     * An adapter for experts. It can also be used with {@link br.com.devfest.norte.ui.widget.CollectionView}. In that case, use
     * {@link ExpertsAdapter#getInventory()} to get a {@link br.com.devfest.norte.ui.widget.CollectionView.Inventory} and
     * set it to the {@link br.com.devfest.norte.ui.widget.CollectionView} by
     * {@link br.com.devfest.norte.ui.widget.CollectionView#updateInventory(br.com.devfest.norte.ui.widget.CollectionView.Inventory)}.
     */
    private class ExpertsAdapter extends CursorAdapter implements CollectionViewCallbacks {
        ...
        /**
         * Returns a new instance of {@link br.com.devfest.norte.ui.widget.CollectionView.Inventory}. It always contains only one
         * {@link br.com.devfest.norte.ui.widget.CollectionView.InventoryGroup}.
         *
         * @return A new instance of {@link br.com.devfest.norte.ui.widget.CollectionView.Inventory}
         */
        ...
        /**
         * {@inheritDoc}
         * This implementation just delegates to {@link ExpertsAdapter#newView(android.content.Context, android.database.Cursor, android.view.ViewGroup)}.
         */
        @Override
        ...
        /**
         * {@inheritDoc}
         * This implementation just delegates to {@link ExpertsAdapter#bindView(android.view.View, android.content.Context, android.database.Cursor)}
         */
        @Override
