 ...
 */
public class NextYearDevFestActivity extends BaseActivity {
    ...
    protected int getSelfNavDrawerItem() {
        return NAVDRAWER_ITEM_NEXT_YEAR_DEVFEST;
    }
	...
	private class SubmitPoll extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPostExecute(Boolean aBoolean) {
			...
			Toast.makeText(NextYearDevFestActivity.this, "Seu voto em " + vote + ", foi registrado com sucesso!", Toast.LENGTH_LONG).show();
		}
	}
}
