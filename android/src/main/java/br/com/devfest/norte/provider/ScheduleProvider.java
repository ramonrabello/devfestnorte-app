...
package br.com.devfest.norte.provider;
...
import br.com.devfest.norte.provider.ScheduleContract.Announcements;
import br.com.devfest.norte.provider.ScheduleContract.Blocks;
import br.com.devfest.norte.provider.ScheduleContract.Experts;
import br.com.devfest.norte.provider.ScheduleContract.Feedback;
import br.com.devfest.norte.provider.ScheduleContract.HashtagColumns;
import br.com.devfest.norte.provider.ScheduleContract.Hashtags;
import br.com.devfest.norte.provider.ScheduleContract.MapMarkers;
import br.com.devfest.norte.provider.ScheduleContract.MapTiles;
import br.com.devfest.norte.provider.ScheduleContract.MySchedule;
import br.com.devfest.norte.provider.ScheduleContract.Partners;
import br.com.devfest.norte.provider.ScheduleContract.PeopleIveMet;
import br.com.devfest.norte.provider.ScheduleContract.Rooms;
import br.com.devfest.norte.provider.ScheduleContract.SearchSuggest;
import br.com.devfest.norte.provider.ScheduleContract.Sessions;
import br.com.devfest.norte.provider.ScheduleContract.Speakers;
import br.com.devfest.norte.provider.ScheduleContract.Tags;
import br.com.devfest.norte.provider.ScheduleContract.VideoColumns;
import br.com.devfest.norte.provider.ScheduleContract.Videos;
import br.com.devfest.norte.provider.ScheduleDatabase.SessionsSearchColumns;
import br.com.devfest.norte.provider.ScheduleDatabase.SessionsSpeakers;
import br.com.devfest.norte.provider.ScheduleDatabase.Tables;
...
import br.com.devfest.norte.appwidget.ScheduleWidgetProvider;
import br.com.devfest.norte.util.AccountUtils;
import br.com.devfest.norte.util.SelectionBuilder;

import static br.com.devfest.norte.util.LogUtils.LOGV;
import static br.com.devfest.norte.util.LogUtils.makeLogTag;

/**
 * Provider that stores {@link br.com.devfest.norte.provider.ScheduleContract} data. Data is usually inserted
 * by {@link br.com.devfest.norte.sync.SyncHelper}, and queried by various
...
public class ScheduleProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case PEOPLE_IVE_MET:
                return PeopleIveMet.CONTENT_TYPE;
            case PEOPLE_IVE_MET_ID:
                return PeopleIveMet.CONTENT_ITEM_TYPE;
            case HASHTAGS:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case PEOPLE_IVE_MET: {
                ...
                notifyChange(uri);
                return PeopleIveMet.buildPersonUri(values.getAsString(PeopleIveMet.PERSON_ID));
            }
            case VIDEOS: {
    ...
    /**
     * Build a simple {@link br.com.devfest.norte.util.SelectionBuilder} to match the requested
    ...
    private SelectionBuilder buildSimpleSelection(Uri uri) {
        ...
        switch (match) {
            ...
            case PEOPLE_IVE_MET_ID: {
                String personId = PeopleIveMet.getPersonId(uri);
                return builder.table(Tables.PEOPLE_IVE_MET)
    ...
    /**
     * Build an advanced {@link br.com.devfest.norte.util.SelectionBuilder} to match the requested
    ...
    /**
     * {@link br.com.devfest.norte.provider.ScheduleContract} fields that are fully qualified with a specific
     * parent {@link ScheduleDatabase.Tables}. Used when needed to work around SQL ambiguity.
     */
