...
public abstract class BaseActivity extends FragmentActivity implements
    ...
    protected static final int NAVDRAWER_ITEM_NEXT_YEAR_DEVFEST = 8;
    ...
    private void populateNavDrawer() {
        ...
        mNavDrawerItems.add(NAVDRAWER_ITEM_NEXT_YEAR_DEVFEST);
...
//                finish();
//                break;
            case NAVDRAWER_ITEM_NEXT_YEAR_DEVFEST:
                intent = new Intent(this, NextYearDevFestActivity.class);
                startActivity(intent);
                finish();
                break;
