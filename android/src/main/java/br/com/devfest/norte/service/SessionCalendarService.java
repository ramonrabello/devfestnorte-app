 ...
 * the {@link android.provider.CalendarContract} API available in Android 4.0 or above.
 */
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "br.com.devfest.norte.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "br.com.devfest.norte.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "br.com.devfest.norte.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "br.com.devfest.norte.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "br.com.devfest.norte.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "br.com.devfest.norte.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_START =
            "br.com.devfest.norte.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_END =
            "br.com.devfest.norte.extra.SESSION_BLOCK_END";
     ...
     * {@link br.com.devfest.norte.provider.ScheduleProvider}, adding or removing
