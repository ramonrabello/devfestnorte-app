...
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "com.google.samples.apps.devfestnorte.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "com.google.samples.apps.devfestnorte.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "com.google.samples.apps.devfestnorte.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "com.google.samples.apps.devfestnorte.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "com.google.samples.apps.devfestnorte.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "com.google.samples.apps.devfestnorte.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_START =
            "com.google.samples.apps.devfestnorte.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_END =
            "com.google.samples.apps.devfestnorte.extra.SESSION_BLOCK_END";
     ...
     * {@link com.google.samples.apps.devfestnorte.provider.ScheduleProvider}, adding or removing
