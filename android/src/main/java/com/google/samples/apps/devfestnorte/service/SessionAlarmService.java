...
package com.google.samples.apps.devfestnorte.service;
...
import com.google.samples.apps.devfestnorte.ui.BrowseSessionsActivity;
import com.google.samples.apps.devfestnorte.ui.MapFragment;
import com.google.samples.apps.devfestnorte.ui.MyScheduleActivity;
import com.google.samples.apps.devfestnorte.ui.SessionFeedbackActivity;
import com.google.samples.apps.devfestnorte.ui.phone.MapActivity;
import com.google.samples.apps.devfestnorte.util.FeedbackUtils;
...
public class SessionAlarmService extends IntentService
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "com.google.samples.apps.devfestnorte.action.NOTIFY_SESSION";
    public static final String ACTION_NOTIFY_SESSION_FEEDBACK =
            "com.google.samples.apps.devfestnorte.action.NOTIFY_SESSION_FEEDBACK";
    public static final String ACTION_SCHEDULE_FEEDBACK_NOTIFICATION =
            "com.google.samples.apps.devfestnorte.action.SCHEDULE_FEEDBACK_NOTIFICATION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "com.google.samples.apps.devfestnorte.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "com.google.samples.apps.devfestnorte.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "com.google.samples.apps.devfestnorte.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "com.google.samples.apps.devfestnorte.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "com.google.samples.apps.devfestnorte.extra.SESSION_ALARM_OFFSET";
    public static final String EXTRA_SESSION_ID =
            "com.google.samples.apps.devfestnorte.extra.SESSION_ID";
    public static final String EXTRA_SESSION_TITLE =
            "com.google.samples.apps.devfestnorte.extra.SESSION_TITLE";
    public static final String EXTRA_SESSION_ROOM =
            "com.google.samples.apps.devfestnorte.extra.SESSION_ROOM";
    public static final String EXTRA_SESSION_SPEAKERS =
            "com.google.samples.apps.devfestnorte.extra.SESSION_SPEAKERS";
    ...
    public static final String ACTION_NOTIFICATION_DISMISSAL
            = "com.google.sample.apps.devfestnorte.ACTION_NOTIFICATION_DISMISSAL";
    ...
    public void scheduleFeedbackAlarm(final String sessionId, final long sessionEnd,
        ...
        feedbackIntent.setData(
                new Uri.Builder().authority("com.google.samples.apps.devfestnorte")
