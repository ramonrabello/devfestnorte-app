...
package com.google.samples.apps.devfestnorte.provider;

import com.google.samples.apps.devfestnorte.appwidget.ScheduleWidgetProvider;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Announcements;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.PeopleIveMet;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Blocks;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Experts;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Feedback;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.MapMarkers;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.MapTiles;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Rooms;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.SearchSuggest;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Sessions;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Speakers;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.Tags;
import com.google.samples.apps.devfestnorte.provider.ScheduleDatabase.SessionsSearchColumns;
import com.google.samples.apps.devfestnorte.provider.ScheduleDatabase.SessionsSpeakers;
import com.google.samples.apps.devfestnorte.provider.ScheduleDatabase.Tables;
import com.google.samples.apps.devfestnorte.util.SelectionBuilder;
...
import com.google.samples.apps.devfestnorte.Config;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract.*;
import com.google.samples.apps.devfestnorte.util.AccountUtils;
...
import static com.google.samples.apps.devfestnorte.util.LogUtils.LOGD;
import static com.google.samples.apps.devfestnorte.util.LogUtils.LOGV;
import static com.google.samples.apps.devfestnorte.util.LogUtils.makeLogTag;

/**
 * Provider that stores {@link ScheduleContract} data. Data is usually inserted
 * by {@link com.google.samples.apps.devfestnorte.sync.SyncHelper}, and queried by various
