...
package com.google.samples.apps.devfestnorte.ui;
...
import com.google.samples.apps.devfestnorte.BuildConfig;
import com.google.samples.apps.devfestnorte.Config;
import com.google.samples.apps.devfestnorte.R;
import com.google.samples.apps.devfestnorte.gcm.ServerUtilities;
import com.google.samples.apps.devfestnorte.io.JSONHandler;
import com.google.samples.apps.devfestnorte.provider.ScheduleContract;
import com.google.samples.apps.devfestnorte.sync.ConferenceDataHandler;
import com.google.samples.apps.devfestnorte.sync.SyncHelper;
import com.google.samples.apps.devfestnorte.ui.debug.DebugActionRunnerActivity;
import com.google.samples.apps.devfestnorte.ui.widget.MultiSwipeRefreshLayout;
import com.google.samples.apps.devfestnorte.ui.widget.SwipeRefreshLayout;
import com.google.samples.apps.devfestnorte.util.AccountUtils;
import com.google.samples.apps.devfestnorte.util.AnalyticsManager;
import com.google.samples.apps.devfestnorte.util.HelpUtils;
import com.google.samples.apps.devfestnorte.util.ImageLoader;
import com.google.samples.apps.devfestnorte.util.LPreviewUtils;
import com.google.samples.apps.devfestnorte.util.LPreviewUtilsBase;
import com.google.samples.apps.devfestnorte.util.LoginAndAuthHelper;
import com.google.samples.apps.devfestnorte.util.PlayServicesUtils;
import com.google.samples.apps.devfestnorte.util.PrefUtils;
import com.google.samples.apps.devfestnorte.util.UIUtils;
import com.google.samples.apps.devfestnorte.util.WiFiUtils;
...
import static com.google.samples.apps.devfestnorte.util.LogUtils.LOGE;
import static com.google.samples.apps.devfestnorte.util.LogUtils.LOGI;
import static com.google.samples.apps.devfestnorte.util.LogUtils.LOGW;
