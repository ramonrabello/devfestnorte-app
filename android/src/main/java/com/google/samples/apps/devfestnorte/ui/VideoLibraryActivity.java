...
public class VideoLibraryActivity extends BaseActivity implements VideoLibraryFragment.Callbacks {
    ...
    private static final String STATE_KEY_YEAR = "com.google.samples.apps.devfestnorte.STATE_KEY_YEAR";
    private static final String STATE_KEY_TOPIC = "com.google.samples.apps.devfestnorte.STATE_KEY_TOPIC";
